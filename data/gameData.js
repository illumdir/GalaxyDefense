 ...
 * Données du jeu extraites du Wiki officiel
 * Source: https://official-galaxy-defense-ftd-wiki.fandom.com/wiki/The_Official_Galaxy_Defense_Fortess_TD_Wiki
 ...
 * ├─────────┼────────────────────────────────────┼─────────────────────────┤
 * │   1     │ Normal (×3) + Chain T1 (×2)        │ Breakthrough T1 (×2)    │
 * │   2     │ Chain T2 (×2-3) + Combo ② (×0-1)  │ Breakthrough T2 (×2)    │
 * │   3     │ Chain T3 (×2) + Combo ③ (×2)       │ Breakthrough T3 (×1)    │
 * └─────────┴────────────────────────────────────┴─────────────────────────┘
 *
 ...
 *   - Cartes Normal : max_copies = 3  → peuvent être sélectionnées jusqu'à 3 fois
 *     (disponibles à tous les paliers, c'est pour ça qu'on peut cumuler sur 3 paliers)
...
const TURRETS = [
  {
    ...
    cards: {
      // ── VERTES palier 1 ──────────────────────────────────────
      // max_copies:3 → ces cartes normales peuvent être prises jusqu'à 3 fois
      normal: [
      ...
      chain: [
        ...
        // Tier 2 — requiert un T1 de la même branche
        ...
        { name: "Thermal Warhead",         tier: 2, color: "green", requires_chain: ["Ignition Amplification","Missile Amplification"], effect: "Small Missiles have a 60% chance to explode upon hitting enemies" },
        // Tier 3
        ...
        { name: "Chain Reaction", tier: 3, color: "green", requires_chain: "Missile Amplification",  effect: "Small Missiles have a 60% chance to launch an additional Small Missile upon hitting an enemy" }
      ],
      // ── VERTES combo (nécessitent une autre tourelle) ────────
      combo: [
        ...
        { name: "Path Strike",           tier: 3, color: "green", requires_turret: "aeroblast",          effect: "Sky Guard Missiles deal DMG to enemies along their path" }
      ],
      // ── VIOLETTES breakthrough ────────────────────────────────
      breakthrough: [
        ...
        { name: "Fire Transmission",  tier: 3, color: "purple", effect: "Missiles apply [Burn] effect to enemies they pass through" }
      ]
    }
  },
  {
    ...
    cards: {
      normal: [
        { name: "Laser Boost",      effect: "Laser DMG +50%",                          tier: 1, color: "green", max_copies: 3 },
        { name: "Laser Duration",   effect: "Laser Duration +40%",                     tier: 1, color: "green", max_copies: 3 },
      ...
      combo: [
        ...
        { name: "Graviton Laser",      tier: 2, color: "green", requires_turret: "gravity_vortex_gun", effect: "Lasers create a pull effect on nearby enemies" },
      ...
      breakthrough: [
        ...
        { name: "Tear Explosions",   tier: 2, color: "purple", effect: "20% chance to trigger a Ripping Laser when hitting enemies with Laser" },
        { name: "Energy Boost",      tier: 3, color: "purple", effect: "Laser DMG +60% for each debuff on enemies (Max: 300%)" }
      ]
    }
  },
  {
    ...
    cards: {
      normal: [
        { name: "Disruption Boost",    effect: "Disruption Drone DMG +50%",          tier: 1, color: "green", max_copies: 3 },
        { name: "Disruption Duration", effect: "Disruption Drone duration +30%",      tier: 1, color: "green", max_copies: 3 },
        { name: "Disruption Range",    effect: "Disruption Drone DMG Range +30%",     tier: 1, color: "green", max_copies: 3 }
      ],
      chain: [
        ...
        { name: "Rewind Teleport",     tier: 2, color: "green", requires_chain: "Random Disturbance", effect: "Teleportation has a 2.5% chance to transport to the start point" },
        ...
        { name: "Overcharged Disruption", tier: 2, color: "green", requires_chain: ["Rewind Teleport","Disruption Burst"], effect: "[Disruption] DMG +100%, Maximum stack count changed to 5 stacks" },
      ...
      combo: [
        ...
        { name: "Electric Field",    tier: 2, color: "green", requires_turret: "thunderbolt", effect: "Enemies hit by Disruption Field have a 30% chance to be inflicted [Paralyze]" },
  ...
  },
  {
    ...
    cards: {
      normal: [
        { name: "Shell Boost",     effect: "Aeroblast Shell DMG +50%",             tier: 1, color: "green", max_copies: 3 },
        { name: "Shell Volley",    effect: "Aeroblast Shell +1, DMG -15%",          tier: 1, color: "green", max_copies: 3 },
        { name: "Shell Knockback", effect: "Aeroblast Shell knockback +50%, DMG -30%", tier: 1, color: "green", max_copies: 3 }
      ],
      chain: [
      ...
      combo: [
        ...
        { name: "Shatter Impact",    tier: 3, color: "green", requires_turret: "laser",            effect: "Aeroblast shell creates two additional Ripping Lasers upon impact" }
      ],
      breakthrough: [
  ...
  },
  {
    ...
    cards: {
      normal: [
        { name: "Thunderbolt Volley",  effect: "Thunderbolt +1, Lightning Strike DMG -15%",        tier: 1, color: "green", max_copies: 3 },
        { name: "Thunderbolt Speed",   effect: "Lightning Strike cooldown speed +10%, DMG -30%",   tier: 1, color: "green", max_copies: 3 },
        { name: "Thunderbolt Boost",   effect: "Lightning Strike DMG +50%",                        tier: 1, color: "green", max_copies: 3 }
      ],
      chain: [
      ...
      breakthrough: [
        ...
        { name: "Thunder Chain",          tier: 2, color: "purple", effect: "Enemies hit by Lightning Strike trigger a Small Chain Lightning each time they take damage (lasts 2s)" },
        { name: "Chain Strike",           tier: 3, color: "purple", note: "Breakthrough qui requiert Chain Lightning T1", effect: "Enemies hit by Chain Lightning have a 25% chance to trigger a Small Lightning Strike" }
      ]
    }
  },
  {
    ...
    cards: {
      normal: [
        { name: "Beam Boost",     effect: "Beam DMG +50%",            tier: 1, color: "green", max_copies: 3 },
        { name: "Beam Speed",     effect: "Beam cooldown speed +30%", tier: 1, color: "green", max_copies: 3 },
        { name: "Beam Duration",  effect: "Beam duration +40%",       tier: 1, color: "green", max_copies: 3 }
      ],
      chain: [
        { name: "Damage Increase",    tier: 1, color: "green", effect: "Beam deals increasing damage to the same target (MAX: 200%)" },
        { name: "Beam Refraction",    tier: 1, color: "green", effect: "When the Beam hits a target, it generates Reflected Beams with +2 refractions" },
        { name: "Stacking Damage",    tier: 2, color: "green", requires_chain: "Damage Increase", effect: "When the Beam switches targets, damage continues to increase" },
        { name: "Refraction Pull",    tier: 2, color: "green", requires_chain: "Beam Refraction",  effect: "Refraction +2, Refracted Beams will pull the hit target towards the center" },
        { name: "Extreme Focus",      tier: 3, color: "green", requires_chain: "Stacking Damage",  effect: "Damage stacking cap increased to 400% MAX" },
        { name: "Refraction Explosion",tier: 3, color: "green", requires_chain: "Refraction Pull", effect: "Each hit by Refracted Beam will cause an explosion" }
      ],
      combo: [
        { name: "Target Explosion", tier: 2, color: "green", requires_turret: "aeroblast",       effect: "Each hit from Beam triggers an explosion" },
        { name: "Disruptive Beam",  tier: 2, color: "green", requires_turret: "disruption_drone",effect: "Targets hit by Beam generate a small disruption field" },
        { name: "Matrix Resonance", tier: 3, color: "green", requires_turret: "teslacoil",       effect: "Beam releases an expanding Electric Matrix on hit" },
        { name: "Beam Lightning",   tier: 3, color: "green", requires_turret: "thunderbolt",     effect: "Each hit from Beam has a 30% chance to trigger 1 Chain Lightning" }
      ],
      breakthrough: [
        { name: "DMG Multiplier",   tier: 1, color: "purple", effect: "Beam DMG interval -40%" },
        { name: "Beam Penetration", tier: 1, color: "purple", effect: "All Beams inflict [Vulnerable] effect to targets" },
        { name: "Slaughtering Beam",tier: 2, color: "purple", effect: "Every enemy killed by Beam, the Beam duration +10% (Max: 100%)" },
        { name: "Extra Beam",       tier: 2, color: "purple", effect: "Release an additional secondary Beam" },
        { name: "Beam Overload",    tier: 3, color: "purple", effect: "All Beams inflict [Vulnerable] effect and additional debuffs" }
      ]
    }
  },
  {
    ...
    cards: {
      normal: [
        ...
        { name: "Firewheel Size",     effect: "Firewheel Drone size +25%",      tier: 1, color: "green", max_copies: 3 },
        { name: "Firewheel Duration", effect: "Firewheel Drone duration +30%",  tier: 1, color: "green", max_copies: 3 }
      ],
      chain: [
      ...
      combo: [
        ...
        { name: "Blazing Pulse",      tier: 3, color: "green", requires_turret: "hive",               effect: "Firewheel Drone releases a pulse wave every 1.5s" }
      ],
      breakthrough: [
  ...
  },
  {
    ...
    cards: {
      normal: [
        { name: "Wasps Boost",   effect: "Wasps DMG +50%",           tier: 1, color: "green", max_copies: 3 },
        { name: "Wasps Count",   effect: "Wasps attack count +2",    tier: 1, color: "green", max_copies: 3 },
        { name: "Wasps Volley",  effect: "Wasps +2, DMG -15%",       tier: 1, color: "green", max_copies: 3 }
      ],
      chain: [
        ...
        { name: "Echo Upgrade II",   tier: 2, color: "green", requires_chain: "Swarm Echo",    effect: "Evolves echoes to Echo Wasp 2" },
        ...
        { name: "Echo Upgrade III",  tier: 3, color: "green", requires_chain: "Echo Upgrade II", effect: "Evolves Echoes to Echo Wasp 3" }
      ],
      combo: [
        { name: "Aero Split",    tier: 2, color: "green", requires_turret: "railgun",    effect: "60% chance for Wasp to split into 3 Small Railgun Shells upon hitting an enemy" },
        { name: "Electro-Wasps", tier: 2, color: "green", requires_turret: "thunderbolt",effect: "Each Wasp attack has 50% chance to release a High-voltage shock" },
        { name: "Volley Wasp",   tier: 3, color: "green", requires_turret: null,         effect: "Wasps bullets +1" },
        { name: "Swarm Fury",    tier: 3, color: "green", requires_turret: "beam",       effect: "Wasps +30% DMG after each attack" }
      ],
      breakthrough: [
        { name: "Wasp Evolution 2",  tier: 1, color: "purple", effect: "Wasp 1 evolves to 2 after 3 attacks" },
        { name: "Hive Mutation 2",   tier: 1, color: "purple", effect: "Hive launches Wasp 2 after 2 volleys" },
        { name: "Wasp Evolution 3",  tier: 2, color: "purple", effect: "Wasp 2 evolves to 3 after 3 attacks" },
        { name: "Wasp Retrieval",    tier: 2, color: "purple", effect: "Wasps have a 50% chance to return to the Hive when destroyed (Max 5 stored)" },
        { name: "Hive Mutation 3",   tier: 2, color: "purple", effect: "Hive has a 50% chance to launch Wasp 3 after 2 volleys" }
      ]
    }
  },
  {
    ...
    cards: {
      normal: [
        { name: "Shell Boost",        effect: "Railgun Shell DMG +50%",                    tier: 1, color: "green", max_copies: 3 },
        { name: "Shell Volley",       effect: "Railgun Shell +1, DMG -15%",                tier: 1, color: "green", max_copies: 3 },
        { name: "Shell Penetration",  effect: "Railgun Shell DMG +30%, Penetration +1",    tier: 1, color: "green", max_copies: 3 }
      ],
      chain: [
      ...
      combo: [
        { name: "Piercing Mark",      tier: 2, color: "green", requires_turret: "disruption_drone", effect: "Enemies hit by all Railgun shells receive [Physical Vulnerable] effect" },
        { name: "Surge Pierce",       tier: 2, color: "green", requires_turret: "teslacoil",        effect: "Railgun Shells have a 50% chance to trigger a high-voltage shock upon enemy kill" },
      ...
      breakthrough: [
        ...
        { name: "Shell Critical Boost",tier: 2, color: "purple", effect: "All Railgun Shells DMG +40%, Critical Rate +30%" },
  ...
  },
  {
    ...
    cards: {
      normal: [
        { name: "Teslacoil Boost",   effect: "Teslacoil DMG +50%",              tier: 1, color: "green", max_copies: 3 },
        { name: "Teslacoil Bounce",  effect: "Teslacoil bounces +1, DMG -15%",  tier: 1, color: "green", max_copies: 3 },
        { name: "Teslacoil Speed",   effect: "Teslacoil cooldown speed +30%",   tier: 1, color: "green", max_copies: 3 }
      ],
      chain: [
        ...
        { name: "Charge Destruction",tier: 2, color: "green", requires_chain: "Charge Expansion", effect: "Teslacoil charge time +0.5s, DMG range increases with charge time" },
        { name: "Enhanced Matrix",   tier: 2, color: "green", requires_chain: "Trap Matrix",       effect: "Electric Matrix DMG +100%, duration +1 second" },
        { name: "Charge Delayed",    tier: 3, color: "green", requires_chain: "Charge Destruction", effect: "Charge time +1 second" },
        { name: "Matrix Thunderbolt",tier: 3, color: "green", requires_chain: "Enhanced Matrix",    effect: "The Electric Matrix spawns a stationary Small Thunderbolt every 0.5s, for 5 seconds" }
      ],
      combo: [
        ...
        { name: "Wasp Mirage",     tier: 2, color: "green", requires_turret: "hive",      effect: "Hitting an Enemy with the Teslacoil summons an Echo Wasp" },
        { name: "Highvolt Trigger",tier: 3, color: "green", requires_turret: "thunderbolt",effect: "Teslacoil Explosion triggers 1 Chain Lightning on hit enemies (MAX: 5)" },
        { name: "Spinning Laser",  tier: 3, color: "green", requires_turret: "laser",     effect: "Teslacoil releases 1 Spinning Laser on hit" }
      ],
      breakthrough: [
        { name: "Electric Chain",      tier: 1, color: "purple", effect: "Teslacoil releases up to 5 high-energy electric shocks on hit to nearby enemies" },
        { name: "Surge",               tier: 1, color: "purple", effect: "Teslacoil Explosion range +30%, Explosion and Electro Matrix inflict [Paralyze] effect" },
        { name: "Electro Interference",tier: 2, color: "purple", effect: "Teslacoil explosion range increased, outer DMG halved" },
        { name: "Expanded Shockwave",  tier: 2, color: "purple", effect: "Teslacoil explosion range increased, outer DMG halved" },
        { name: "Charged Shock",       tier: 3, color: "purple", effect: "During Teslacoil charging, releases up to 2 high-energy electric shocks every 0.25s" }
      ]
    }
  },
  {
    ...
    cards: {
      normal: [
        { name: "Field Boost",    effect: "Gravitational Field DMG +50%",             tier: 1, color: "green", max_copies: 3 },
        { name: "Field Range",    effect: "Gravitational Field range +25%",           tier: 1, color: "green", max_copies: 3 },
        { name: "Field Distance", effect: "Gravitational Field flight distance +30%", tier: 1, color: "green", max_copies: 3 }
      ],
      chain: [
      ...
      combo: [
        { name: "Field Reflection", tier: 2, color: "green", requires_turret: "laser",          effect: "All Gravitational Fields can reflect" },
        { name: "Field Disruption", tier: 2, color: "green", requires_turret: "disruption_drone",effect: "Gravitational Field inflicts [Disruption] effect on hit" },
        ...
        { name: "Binary Stars",     tier: 3, color: "green", requires_turret: "hive",           effect: "Gravitational field splits into a pair of spinning Binary Stars" }
      ],
      breakthrough: [
...
// Helper : retourner toutes les tourelles sélectionnées
// Logique des combo cards : une carte combo est jouable si
//   sa requires_turret est dans la liste des tourelles sélectionnées
...
// Helper : liste complète des gardiens à plat
